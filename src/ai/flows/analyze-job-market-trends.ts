...
const AnalyzeJobMarketTrendsOutputSchema = z.object({
  trendingRoles: z.array(z.string()).describe('A list of trending job roles in the specified domain and location.'),
